...
<?php foreach($invoiceBills->toArray() as $data){
	...
	<tr>
	<td colspan="4"
 		style="text-align:center;font-size:12px !important;"><span><?=@$data->company->address?></span></td>
	</tr>
	<tr><td colspan="4"
	...
	<tr>
		<td colspan="4"
		style="text-align:center;font-size:16px; padding-bottom:10px;  padding-top:10px;"><b><span><u>TAX INVOICE</u></span></b></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<?= h(str_pad(@$data->customer_name, 4, '0', STR_PAD_LEFT))?>
		<?php }?>
		<?=ucwords($data->customer_name)?></b></td>
	</tr>
	<?php if(!empty($data->customer_name)){?>
	<tr>
		<td colspan="4" style="font-size:14px;">Mobile No: 
		<?=$data->customer_mobile?></td>
	</tr>
	<?php } ?>
	<!--<tr>
