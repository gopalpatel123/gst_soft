				...
				<?= $this->Form->create($salesInvoice,['onsubmit'=>'return checkValidation()']) ?>
					...
					<div class="row">
						<div class="col-md-3">
								...
								<?php echo $this->Form->control('customer_name',['empty'=>'-Select Party-', 'class'=>'form-control input-sm customer_name ','label'=>false,'required'=>'required', 'value'=>$salesInvoice->customer_name]);
								?>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label>Customer Mobile</label>
								<?php echo $this->Form->control('customer_mobile',['empty'=>'-Select Party-', 'class'=>'form-control input-sm customer_mobile','label'=>false,'required'=>'required', 'value'=>$salesInvoice->customer_mobile]);
								?>
							</div>
						</div> 
					</div>
